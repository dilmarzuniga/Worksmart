...
<div class="left_content">
			...
			<TABLE class='t_categ'>
          	<tr>
			<th class='encabezado' colspan='2'> Trabajos Ordenados por categoria </th></tr>
			
           	<TR>
            <TD align='Left' class='celda'><a class="buscar" href='Busqueda_personalizada.php?Tipo=categoria&Categoria=arte+Diseño&depto=no'> Arte/dise&ntilde;o/ medios </a></TD>
            <TD align='Left' class='celda'><a class="buscar" href='Busqueda_personalizada.php?Tipo=categoria&Categoria=informatica&depto=no'> Inform&aacute;tica / Telecom </a></TD>
	      	</tr>
			<TR>
			<TD align='Left' class='celda'><a class="buscar" href='Busqueda_personalizada.php?Tipo=categoria&Categoria=call+Center&depto=no' > Recepcion / Call Center </a></TD> 
			<TD align='Left' class='celda'><a class="buscar" href='Busqueda_personalizada.php?Tipo=categoria&Categoria=Contabilidad&depto=no'> Econom&iacute;a / Contabilidad </a></TD>
			</tr>
			<tr>
				<TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Tipo=categoria&Categoria=Turismo&depto=no"> Hosteler&iacute;a / Turismo</a></TD>
			   	<TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=servicio+al+cliente&depto=no">Servicio al cliente / meseros / Bar Tender </a></TD>
	    	</tr>
			<tr>
				<TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Tipo=categoria&Categoria=ventas&depto=no"> Ventas </a></TD>
				<TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Tipo=categoria&Categoria=medicina&depto=no"> Medicina / Salud </a></TD>
			</tr>
			<tr>
			   	<TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Tipo=categoria&Categoria=otros&depto=no"> Otros </a></TD>
			    <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=Administraci&oacute;n+Oficinas&depto=no"> Administraci&oacute;n Oficinas </a></TD>
			 </tr>
...
<div class="right_content">
  <CENTER>
	  <TABLE class='t_categ'>
          	<tr>
			<th class='encabezado' colspan="2"> Trabajos ordenados por lugar </th>
			</tr>
			
           	<TR>
               <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=San+Salvador"> San Salvador </a> </TD>
               <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=Usulutan"> Usulután </a></TD>
	      	</tr>
			<tr>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=La+Paz"> La Paz</a></TD> 
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=Santa+Ana"> Santa Ana</a></TD>
			</tr>
			<tr>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=Sonsonate"> Sonsonate </a></TD>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=chalatenango"> Chalatenango </a></TD>
	    </tr>
			 <tr>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=Ahuachapan"> Ahuachapán </a></TD>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=La+Union"> La Unión </a></TD>
			 </tr>
			 <tr>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=Caba&ntilde;as"> Caba&ntilde;as</a></TD>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=cuscatl&aacute;n"> Cuscatlán </a></TD>
			 </tr>
			 <tr>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=San+vicente"> San Vicente </a></TD>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=libertad"> La Libertad </a></TD>
			 </tr>
			 <tr>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=Santa+Ana"> Santa Ana </a></TD>
			   <TD align='Left' class='celda'><a class="buscar" href="Busqueda_personalizada.php?Categoria=no&depto=San+miguel"> San Miguel </a></TD>
   	  </tr>
  </TABLE></center>
