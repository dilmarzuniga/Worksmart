    ...
    <div class="main_content">
	  <div class="menutips">
    		...
    		<div class="tipsizquierdo">
    		 <h1>¿Entonces que debo hacer?</h1>
			 <p>
			 
			 Ya te hemos dado algunas claves para que salgas airoso de una entrevista de trabajo. A continuación te daremos algunos consejos para el momento mismo de la entrevista. Toma nota de estos pequeños tips pero de gran utilidad:
<ul type="circle">

<li>Es muy importante que estés correctamente informado sobre la empresa u organismo en el que estás solicitando un empleo. Sin entrar en demasiados detalles, será de gran valor que conozcas el tipo de producto o servicio que comercializa, número de empleados, horarios de funcionamiento, en qué consiste el puesto al que te postulas (sus tareas, obligaciones, requisitos, etc.), cuánto se paga en el mercado por un puesto similar, y otros detalles que son relativos al puesto.
<li>No está de más repetir que deberás llegar puntual a tu cita, para lo cual debes tener en cuenta que pueden sucederte imprevistos (no conseguir un taxi, un ómnibus que pasa fuera de hora, un embotellamiento en el tráfico, etc.).
<li>Por supuesto no deberás masticar chicle ni fumar durante la entrevista, camina derecho y al estrechar la mano de tu empleador hazlo con firmeza pero sin apretar demasiado. Sientate cuando te inviten a hacerlo, nunca antes, pues demuestra un grado de confianza que aún no te ha sido otorgado.
<li>Demuestra que consideras la entrevista de gran importancia y mantente concentrado.
